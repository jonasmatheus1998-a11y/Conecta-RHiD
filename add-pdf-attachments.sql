...
drop function if exists public.save_record_conecta(uuid, uuid, text, jsonb, text, text);
drop function if exists public.save_record_conecta(uuid, uuid, text, jsonb, text, text, jsonb);
